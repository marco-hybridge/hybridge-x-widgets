...
function typeLines(lines, cb) {
  ...
  function next() {
    ...
    // Prompts más lentos que el output para simular escritura
...
function showFinal() {
  ...
  final.innerHTML = `
    ...
    <button class="hb-btn hb-btn-primary" style="margin-top: 2rem;" onclick="location.reload()">
      🔄 Repetir Laboratorio
    </button>
  `;
